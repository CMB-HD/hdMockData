...
- For version `'v1.2` (the default, latest version):
  - [MacInnis et. al. (2026)](https://arxiv.org/abs/XXXX.XXXXX) (**TODO:LINK2PAPER**) if you use the CMB-HD noise spectra, foreground spectra, or covariance matrices.
  - [Cheslog et. al. (2026)](https://arxiv.org/abs/YYYY.YYYYY) (**TODO:LINK2PAPER**) if you use the theory power spectra or CAMB/CLASS parameter settings.
...
- `v1.2`: Currently the latest. Contains new simulation-based noise curves and corresponding covariance matrices from [MacInnis et. al. (2026)](https://arxiv.org/abs/XXXX.XXXXX) (**TODO:LINK2PAPER**), along with the CAMB/CLASS accuracy settings from [Cheslog et. al. (2026)](https://arxiv.org/abs/YYYY.YYYYY) (**TODO:LINK2PAPER**). The changes relative to the previous version are:
  ...
  - Updated CAMB accuracy settings, new CLASS accuracy settings, and corresponding CMB and CMB lensing theory power spectra.
    ...
    - To use the CLASS accuracy settings, please follow the CLASS modifications specified in Appendix A of [Cheslog et. al. (2026)](https://arxiv.org/abs/YYYY.YYYYY) (**TODO:LINK2PAPER**).
